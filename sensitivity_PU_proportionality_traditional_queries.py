    ...
    if model_name in all_model_energies:
        ...
        if not np.isnan(energies).all():
            ...
            legend_elements.append(plt.Line2D([0], [0], color=color_dict[model_name], 
                                 label=f'{model_name}: {p50:.3f} Wh (IQR:{p25:.3f}-{p75:.3f})', 
                                 linewidth=3))
...
# plt.savefig('manuscript_figures/figure1_per_query_energy_consumption.svg', format='svg', dpi=300, bbox_inches='tight')
# plt.savefig('manuscript_figures/figure1_per_query_energy_consumption.png', format='png', dpi=300, bbox_inches='tight')
...
plt.savefig('manuscript_figures/updated_figures/figure2_PUsens.svg', format='svg', dpi=300, bbox_inches='tight')
plt.savefig('manuscript_figures/updated_figures/figure2_PUsens.png', format='png', dpi=300, bbox_inches='tight')
...
# plt.savefig('manuscript_figures/figure3_token_length_distribution.svg', format='svg', dpi=300, bbox_inches='tight')
# plt.savefig('manuscript_figures/figure3_token_length_distribution.png', format='png', dpi=300, bbox_inches='tight')
